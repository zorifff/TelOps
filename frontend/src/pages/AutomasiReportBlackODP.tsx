...
export default function AutomasiReportBlackODP() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const url = `/api/report-black-odp/generate?type_design=${typeDesign}`;
      ...
      const defaultFilename = `Report_Black_ODP_${labelMap[typeDesign]}.xlsx`;
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex flex-col">
            <h2 className="text-[20px] font-bold text-[#001a3f] m-0">Automasi Report Black ODP</h2>
            <span className="text-[13px] text-slate-500 font-medium">Analisis pergerakan ODP Black berbasis data WoW</span>
          </div>
        ...
        {isGuideOpen && (
          <div className="px-8 py-5 bg-slate-50 border-b border-slate-200">
            <div className="bg-[#f8fafc] border border-[#cbd5e1] rounded-xl p-6 font-['Poppins'] text-[#344970] text-[14px] leading-relaxed shadow-sm">
              <p className="mb-4">
                Agar sistem dapat menghitung data Report Black ODP dengan presisi, pastikan file Excel yang Anda unggah memenuhi kriteria berikut:
              </p>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><b>Greenfield:</b> Memproses data ODP Black khusus tipe Greenfield (1 tabel).</li>
                  <li><b>Brownfield:</b> Memproses data ODP Black khusus tipe Brownfield (1 tabel).</li>
                  <li><b>All Type Design:</b> Memproses seluruh data ODP Black tanpa memfilter Type Design (1 tabel).</li>
                  <li><b>Combined (3 Tabel):</b> Menggabungkan ketiga tabel (Greenfield, Brownfield, dan All Type Design) secara berurutan dalam 1 sheet <code>Report - ODP Black</code>.</li>
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Wajib memiliki kolom: <code className="bg-gray-200 px-1.5 py-0.5 rounded font-mono text-[13px]">OCC 2</code> (Untuk filter ODP Black)</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Wajib memiliki sheet: <code className="bg-gray-200 text-[#ee2e24] px-1.5 py-0.5 rounded font-mono text-[13px]">Report - ODP Black</code></li>
                  <li>Jika tabel tipe tertentu tidak ditemukan di file W-1, kolom <i>Black ODP Previous Week</i> pada tabel tersebut akan otomatis diset kosong (-).</li>
                </ul>
              </div>
            </div>
          </div>
