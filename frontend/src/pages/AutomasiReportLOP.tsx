...
export default function AutomasiReportLOP() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const url = `/api/report-lop/generate?type_design=${typeDesign}`;
      ...
      const defaultFilename = `Report_LOP_ODP_Golive_2026_${labelMap[typeDesign]}.xlsx`;
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex flex-col">
            <h2 className="text-[20px] font-bold text-[#001a3f] m-0">Automasi Report LOP</h2>
            <span className="text-[13px] text-slate-500 font-medium">Analisis pencapaian Okupansi per LOP berbasis data WoW</span>
          </div>
        ...
        {isGuideOpen && (
          <div className="px-8 py-5 bg-slate-50 border-b border-slate-200">
            <div className="bg-[#f8fafc] border border-[#cbd5e1] rounded-xl p-6 font-['Poppins'] text-[#344970] text-[14px] leading-relaxed shadow-sm">
              <p className="mb-4">
                Agar sistem dapat menghitung data Report LOP dengan presisi, pastikan file Excel yang Anda unggah memenuhi kriteria berikut:
              </p>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><b>Greenfield:</b> Memproses data LOP khusus tipe Greenfield (1 tabel).</li>
                  <li><b>Brownfield:</b> Memproses data LOP khusus tipe Brownfield (1 tabel).</li>
                  <li><b>All Type Design:</b> Memproses seluruh data LOP tanpa memfilter Type Design (1 tabel).</li>
                  <li><b>Combined (3 Tabel):</b> Menggabungkan ketiga tabel (Greenfield, Brownfield, dan All Type Design) secara berdampingan dalam 1 sheet <code>Report per LOP</code>.</li>
                </ul>
              </div>
